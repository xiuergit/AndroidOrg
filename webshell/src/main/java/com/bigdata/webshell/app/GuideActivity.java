...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.welcome_view2, null));
        pageViews.add(inflater.inflate(R.layout.welcome_view3, null));

        //创建imageviews数组，大小是要显示的图片的数量
        imageViews = new ImageView[pageViews.size()];
        //从指定的XML文件加载视图
        viewPics = (ViewGroup) inflater.inflate(R.layout.firstwelcome_activity, null);
        ...
        for(int i=0;i<pageViews.size();i++){
            ...
            //设置小圆点imageview的参数
            imageView.setLayoutParams(new ViewGroup.LayoutParams(30,30));//创建一个宽高均为30 的布局
...
//    }
    ...
    class GuidePageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(View v, int position) {
            ...
            // 测试页卡1内的按钮事件
            if (position == 1) {
                Button btn = (Button) v.findViewById(R.id.btn_gomain);
