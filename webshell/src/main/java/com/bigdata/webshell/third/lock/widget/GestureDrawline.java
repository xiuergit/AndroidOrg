package com.bigdata.webshell.third.lock.widget;
...
import com.bigdata.webshell.third.lock.Constants;
import com.bigdata.webshell.third.lock.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		super(context);
		screenDispaly = WebAppUtil.getScreenDisplayPx(context);
