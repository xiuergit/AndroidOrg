...
import com.bigdata.webshell.third.lock.widget.LockIndicator;
...
public class GestureEditActivity extends FragmentActivity implements OnClickListener {
    ...
    private void setUpViews() {
        ...
        mTextCancel = (TextView) findViewById(R.id.text_cancel_edit);
    ...
    public void onClick(View v) {
         ...
         if(v.getId()==R.id.text_cancel_edit){
             this.finish();

         }else if(v.getId()==R.id.text_reset) {
             mIsFirstInput = true;
             updateCodeList("");
